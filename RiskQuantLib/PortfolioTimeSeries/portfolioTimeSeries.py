...
import numpy as np
import pandas as pd
from RiskQuantLib.PortfolioList.portfolioList import portfolioList
...
class portfolioTimeSeries(listBase,setPortfolioList):
    ...
    def addSubPortfolioByBenchmark(self, linkedAttrName = ''):
        self.execFunc('execFunc','addSubPortfolioByBenchmark', linkedAttrName)
