...
class setBase():
    ...
    def setWeight(self, weightValue):
        ...
        if not hasattr(self, '__weight'):
            self.__weight = weight(weightValue)
            self.weight = self.__weight.value
        else:
            self.__weight.setValue(weightValue)
            self.weight = self.__weight.value
    def setRtn(self, rtnValue):
        from RiskQuantLib.Property.Rtn.rtn import rtn
        if not hasattr(self, '__rtn'):
            self.__rtn = rtn(rtnValue)
            self.rtn = self.__rtn.value
        else:
            self.__rtn.setValue(rtnValue)
            self.rtn = self.__rtn.value
