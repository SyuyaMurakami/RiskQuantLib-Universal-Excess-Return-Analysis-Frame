...
class pathObj():
    ...
    pathDict["SubPortfolio"] = "Set" + os.sep + "SubPortfolio" + os.sep + "subPortfolio.py"
    pathDict["Portfolio"] = "Set" + os.sep + "Portfolio" + os.sep + "portfolio.py"
    pathDict["Benchmark"] = "Set" + os.sep + "Benchmark" + os.sep + "benchmark.py"
    ...
    listPathDict["SubPortfolio"] = "Set" + os.sep + "SubPortfolioList" + os.sep + "subPortfolioList.py"
    listPathDict["Portfolio"] = "Set" + os.sep + "PortfolioList" + os.sep + "portfolioList.py"
    listPathDict["Benchmark"] = "Set" + os.sep + "BenchmarkList" + os.sep + "benchmarkList.py"
    # build module, contents below will be automatically built and replaced, self-defined functions shouldn't be written here
    #-<listPathDictBegin>
    #-<listPathDictEnd>
    ...
    classPathDict["SubPortfolio"] = "RiskQuantLib.SubPortfolio.subPortfolio"
    classPathDict["Portfolio"] = "RiskQuantLib.Portfolio.portfolio"
    classPathDict["Benchmark"] = "RiskQuantLib.Benchmark.benchmark"
    # build module, contents below will be automatically built and replaced, self-defined functions shouldn't be written here
    #-<classPathDictBegin>
    #-<classPathDictEnd>
    ...
    classNameDict["SubPortfolio"] = "subPortfolio"
    classNameDict["Portfolio"] = "portfolio"
    classNameDict["Benchmark"] = "benchmark"
    # build module, contents below will be automatically built and replaced, self-defined functions shouldn't be written here
    #-<classNameDictBegin>
    #-<classNameDictEnd>
    ...
    attributeTypeDict['Rtn'] = 'Property' + os.sep + 'Rtn' + os.sep + 'rtn.py'
    attributeTypeDict['Date'] = 'Property' + os.sep + 'Date' + os.sep + 'date.py'
    # build module, contents below will be automatically built and replaced, self-defined functions shouldn't be written here
