...
result[['accuRtn','benchmarkAccuRtn','excessAccuRtn']+result.columns.to_list()[:-3]].to_excel(path+os.sep+'Result'+os.sep+'多期Brinson归因.xlsx')
print("Finished")
